...
private:
    ...
    public:
        ...
        {
            /*
                Fixes deallocation crash with VST when reopening GUI to a video player --
                see https://github.com/Hanley1/JUCE/commit/0fb4cad08166ee715215347ffb2d38db36b5e616
                and https://forum.juce.com/t/high-sierra-avplayer-deallocation-crash/32905/1
             */
            detachPlayerStatusObserver();
            detachPlaybackObserver();
            setPlayer (nil);
